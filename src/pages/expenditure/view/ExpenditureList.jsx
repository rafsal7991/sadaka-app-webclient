    ...
    <>
      <div>
        ...
        <div className="md:flex justify-between items-center mt-6">
          ...
          <h7 className="text-lg font-bold"> Expenditure List</h7>
          <h7 className="mb-4">A list of all Expenditures</h7>
          </div>
        
          <button
            className="btn btn-primary flex gap-2"
            onClick={() => {
              navigate("/transactionManagement/addExpenditure");
            }}
          >
           <PlusCircle size={15}/>   Add Expenditure
          </button>
        </div>
