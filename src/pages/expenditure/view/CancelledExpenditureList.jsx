...
const   CancelledExpenditureList = () => {
    ...
    },
    {
      ...
      Cell: (row) => {
        return (
            ...
            onClick={() => navigate("/settings/viewSp")}
            >
    ...
    <>
      <div>
        ...
        <div className="md:flex justify-between items-center mt-6">
          ...
          <h7 className="text-lg font-bold">Cancelled Expenditure List</h7>
          <h7 className="mb-4">A list of all Cancelled Expenditures</h7>
          </div>
        </div>
...
export default CancelledExpenditureList
