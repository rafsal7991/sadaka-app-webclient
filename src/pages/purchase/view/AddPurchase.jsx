...
const AddPurchase = () => {
  ...
  return (
    <div className="page-wrapper">
      ...
      <h4 className="card-title"> Add New Purchases</h4>
      <p className="" style={{ fontSize: '12px' }}>Add New Purchases</p>
              ...
              <div className="flex space-x-4">
                <div className="form-group">
                  <div className="horizontal-line">
                    ...
                    <div className="form-group-container" style={{ display: 'flex', gap: '20px' }}>
                      <div className="form-group">
