...
const UserTable2 = () => {
            ...
            <Badge
              ...
              className={
                row?.cell?.value === "superadmin"
                  ? "border-fuchsia-500 text-fuchsia-500 border rounded-full"
                  : row?.cell?.value === "admin"
                  ? "border-green-500 text-green-500 border rounded-full"
                  : "border-indigo-500 text-indigo-500 border rounded-full"
              }
            />
          </span>
        );
    ...
    },
    {
      ...
      Cell: (row) => {
        ...
        const handleCheckboxChange = () => {
          ...
          updatedData[row.cell.row.index].status = !checked;
          setChecked(!checked);
        };
  ...
  return (
    <>
      ...
      <div className="card">
        <h6 className="text-lg font-medium mb-2">A list of all users</h6>
