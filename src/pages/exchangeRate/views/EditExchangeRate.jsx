          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 ">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="form-group">
                <label>
                  ExchangeRate Code <span className="text-red-500">*</span>
                </label>
                <Textinput
                  placeholder="Admin"
                  id="bs_01"
                  ...
                  register={register}
                  error={errors.ExchangeRateCode}
                  //  onChange={handleChangeExchangeRateAndDescriprion}
                />
              </div>
              <div className="form-group">
                <label>
                  ExchangeRate Description <span className="text-red-500">*</span>
                </label>
                <Textinput
                  placeholder="Admin"
                  id="bs_01"
                  type="text"
                  name="ExchangeRateDescription"
                  register={register}
                  error={errors.ExchangeRateDescription}
                  // onChange={handleChangeExchangeRateAndDescriprion}
                />
              </div>
            </div>
