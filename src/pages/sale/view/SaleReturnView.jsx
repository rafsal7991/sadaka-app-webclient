...
const SaleReturnView= () => {
  ...
  const SaleReturnDetail = location.state.row;
  console.log("sale",SaleReturnDetail);
        ...
        <table className="min-w-full dark:divide-gray-700">
          <tbody className='bg-white divide-y divide-gray-100 dark:bg-gray-800 dark:divide-gray-700'>
            <tr>
              ...
              <td className="border px-4 py-2">{SaleReturnDetail.ZNum}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="border px-4 py-2">{SaleReturnDetail.Ccy}</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Billed Amount</td>
              <td className="border px-4 py-2">{SaleReturnDetail.BillAmt}</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Billed Tax Amount</td>
              <td className="border px-4 py-2">{SaleReturnDetail.BillEqvAmt}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="border px-4 py-2">{SaleReturnDetail.SlDiscAmt}</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Cancel Reason</td>
              <td className="border px-4 py-2">{SaleReturnDetail.SlCanclRsn}</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Added By</td>
              <td className="border px-4 py-2">{SaleReturnDetail.SlGenBy}</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Added On</td>
              <td className="border px-4 py-2">{SaleReturnDetail.GenDt}</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Approved By</td>
              <td className="border px-4 py-2">{SaleReturnDetail.SlApvdBy}</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Approved On</td>
              <td className="border px-4 py-2">{SaleReturnDetail.SlApvdDt}</td>
            </tr>
            <tr>
