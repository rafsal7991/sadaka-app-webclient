        ...
        <table className="min-w-full dark:divide-gray-700">
          <tbody className='bg-white divide-y divide-gray-100 dark:bg-gray-800 dark:divide-gray-700'>
            <tr>
              ...
              <td className="border px-4 py-2">SP ADMIN</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Category</td>
              <td className="border px-4 py-2">SP_ADMIN</td>
            </tr>
            <tr>
            ...
            <tr>
              <td className="border px-4 py-2 font-semibold ">Descriptions</td>
              <td className="border px-4 py-2">SP ADMIN</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Added By</td>
              <td className="border px-4 py-2">e-retail.admin</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold ">Added On</td>
              <td className="border px-4 py-2">2023-04-01T11:07:59.001344</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="border px-4 py-2">2022-06-24T22:48:47</td>
            </tr>
            <tr>
...
export default Viewcodeclassfication;
