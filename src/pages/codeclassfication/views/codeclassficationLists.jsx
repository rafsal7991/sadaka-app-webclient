                  ...
                  >
                    <div
                      ...
                      onClick={() => {
                         switch (item.name) {
                          case "View":
                            navigate("/userManagement/viewPermission")
                            break;
                          case "Edit":
                            navigate("/userManagement/addPermission")
                            break;
  ...
  return (
    <>
      ...
      <div className="md:flex justify-between items-center mb-6">
        <h4 className="card-title mt-2">Codeclassfication</h4>
        <div className="flex space-x-2">
          {/* <GlobalFilter filter={globalFilter} setFilter={setGlobalFilter} /> */}
          <button
            className="btn btn-primary flex gap-2"
            onClick={() => {navigate('/userManagement/addPermission')}}
          >
          <PlusCircle size={15}/>  Add Permission
          </button>
        </div>
      </div>
...
export default CodeclassficationLists;
