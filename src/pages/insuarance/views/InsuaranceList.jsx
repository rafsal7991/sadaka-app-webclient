...
const InsuaranceList = () => {
  const navigate=useNavigate();
  const user = useSelector((e) => e.user);
  const Insuarance = user.userInfo.UsrResp.UsrDtl.PermDtl;
                  ...
                  >
                    <div
                      ...
                      onClick={() => {
                         switch (item.name) {
                          case "View":
                            navigate("/userManagement/viewInsuarance")
                            break;
                          case "Edit":
                            navigate("/userManagement/addInsuarance")
                            break;
  ...
  return (
    <>
      ...
      <div className="md:flex justify-between items-center mb-6">
        <h4 className="card-title mt-2">Insuarance</h4>
        <div className="flex space-x-2">
          {/* <GlobalFilter filter={globalFilter} setFilter={setGlobalFilter} /> */}
          <button
            className="btn btn-primary flex gap-2"
            onClick={() => {navigate('/settings/addInsuarance')}}
          >
          <PlusCircle size={15}/>  Add Insuarance
          </button>
        </div>
      </div>
