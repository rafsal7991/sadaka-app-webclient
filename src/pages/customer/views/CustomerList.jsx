...
const CustomerList = () => {
  ...
  async function getCustomerList() {
    setIsLoading(true);
    const result = await CustomerController.getCustomersBySubSpRefNum(
    ...
    if (result.error) {
      ...
      const customerResponseWrapper = result.resultCurl;
      const customerDtl = customerResponseWrapper.CustomResp.CustomDtl.map((e,index) => {
        return {
          sNo:index+1,
          ApvdBy: e.ApvdBy,
          ApvdDt: e.ApvdDt,
          CustomAddrs: e.CustomAddrs,
          CustomEmail: e.CustomEmail,
          CustomerpinNumber: e.CustomId,
          customerName: e.CustomNm,
          CstphoneNumber: e.CustomPhNum,
          CustomPhNum1: e.CustomPhNum1,
          GenBy: e.GenBy,
          GenDt: e.GenDt,
          IdTyp: e.IdTyp,
          IdTypCode: e.IdTypCode,
          SpRefNum: e.SpRefNum,
    ...
    //   },
    {
      ...
      Cell: (row) => {
        ...
        GlobalMethod.getUserPermissionName(permission)
          ...
          onClick={() =>{ 
            navigate("/settings/viewCustomer" ,{
        ...
        GlobalMethod.getUserPermissionName(permission)
          ...
          onClick={() =>{ 
            navigate("/settings/editCustomer" ,{
              state: { row: row?.cell?.row?.original},
              })
            }}
          >
  ...
  return (
    <>
      ...
      <div className="md:flex justify-between items-center mb-6">
        <h4 className="card-title mt-2">Customers</h4>
