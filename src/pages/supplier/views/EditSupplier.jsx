...
const schema = yup
  .object({
   ...
   supplierPhoneNumber : yup
      .string()
      .required("Supplier Phone Number 1 is Required"),
  })
  .required();
...
const EditSupplier = () => {
  ...
  const EdSupplier =location.state.row;
  console.log(EdSupplier);
        ...
        <div className="card p-3">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 ">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-group">
                <label>
                Supplier Phone Number 1*<span className="text-red-500">*</span>
                </label>
                <Textinput
                  placeholder="Supplier Phone Number 1*"
                  id="bs_01"
                  value={EdSupplier.SupplPh1}
                  type="text"
                  name="supplierPhoneNumber"
                  register={register}
                  error={errors.supplierPhoneNumber}
                  // onChange={handleChangePermissionAndDescriprion}
                />
              </div>
              <div className="form-group">
