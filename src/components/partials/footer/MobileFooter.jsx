    ...
    <div className="bg-white bg-no-repeat custom-dropshadow footer-bg dark:bg-gray-700 flex justify-around items-center backdrop-filter backdrop-blur-[40px] fixed left-0 w-full z-[9999] bottom-0 py-[12px] px-4">
      <NavLink to="chat">
        {({ isActive }) => (
         ...
         ${isActive ? "text-[#13317d]" : "dark:text-white text-gray-900"}
          `}
            >
          ...
          ${isActive ? "text-[#13317d]" : "text-gray-600 dark:text-gray-300"}
          `}
            >
              Messages
            </span>
      ...
      >
        {({ isActive }) => (
          ...
          ${
            isActive ? "border-2 border-[#13317d]" : "border-2 border-gray-100"
          }
              `}
            />
          </div>
