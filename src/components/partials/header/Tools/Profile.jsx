...
import { logoutSuccess } from "../../../../store/slices/auth/userSlice";
...
const Profile = ({ sticky }) => {
  ...
  const userDetail = useSelector((e) => e.user.userInfo?.UsrResp.UsrDtl);
    ...
    >
      <div className="flex items-center px-4 py-3 border-b border-gray-10 mb-3">
        ...
        <div className="flex-1 text-gray-700 dark:text-white text-sm font-semibold  ">
          <span className=" truncate w-full block">{  `${userDetail.FNm} ${userDetail.LNm}`}</span>
