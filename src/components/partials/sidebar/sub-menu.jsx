...
const Submenu = ({ activeSubmenu, item, i }) => {
  ...
  const permission = useSelector((e) => e.user.userInfo.UsrResp.UsrDtl.PermDtl);
      ...
      return (
        <span className="text-sm flex space-x-3 items-center transition-all duration-150  cursor-not-allowed">
          ...
          <div className="flex-1 dark:text-gray-300/60 text-gray-600/50">
            {subItem.childtitle}
            <span className="badge bg-cyan-500/10 text-[#13317d] py-1 ltr:ml-2 rtl:mr-2  rounded-full">
              {subItem.badge}
            </span>
          </div>
        </span>
