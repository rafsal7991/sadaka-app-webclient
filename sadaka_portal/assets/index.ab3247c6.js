import{a as e,j as t,aa as n}from"./index.ef1be1b9.js";import{c as a}from"./code-snippet.9dcb43e4.js";const s=()=>e("div",{className:"space-xy",children:[t(n,{text:"primary",className:"btn-primary "}),t(n,{text:"secondary",className:"btn-secondary"}),t(n,{text:"success",className:"btn-success"}),t(n,{text:"info",className:"btn-info"}),t(n,{text:"warning",className:"btn-warning"}),t(n,{text:"error",className:"btn-danger"}),t(n,{text:"Dark",className:"btn-dark"}),t(n,{text:"Light",className:"btn-light"})]}),o=`
